...
public class ArticleDetailFragment extends Fragment implements
    ...
    android.support.v7.widget.Toolbar fragToolbar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((CollapsingToolbarLayout) mRootView.findViewById(R.id.collapsing_toolbar_layout)).setCollapsedTitleTextAppearance(R.style.CollapsedAppBarCollapsed);
        ((CollapsingToolbarLayout) mRootView.findViewById(R.id.collapsing_toolbar_layout)).setExpandedTitleTextAppearance(R.style.CollapsedAppBarExpanded);

        ButterKnife.bind(this, mRootView);
        setHasOptionsMenu(true);
        ((AppCompatActivity)getActivity()).setSupportActionBar(fragToolbar);
        ((AppCompatActivity)getActivity()).getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        fragToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
        ...
        scrollMain.setOnScrollChangeListener(new ScrollView.OnScrollChangeListener(){
            @Override
...
//        updateStatusBar();
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ArticleLoader loader = ArticleLoader.newInstanceForItemId(getActivity(), mItemId);
        actual = false;
        return loader;
    }
