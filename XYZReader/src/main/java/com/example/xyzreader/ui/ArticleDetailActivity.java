...
//                mSelectedItemId = mCursor.getLong(ArticleLoader.Query._ID);
        ...
        mUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ArticleDetailFragment.actual = true;
//                onBackPressed();
...
//            mSelectedItemUpButtonFloor = fragment.getUpButtonFloor();
    ...
    private void updateUpButtonPosition() {
        int upButtonNormalBottom = mTopInset + (mUpButton.getHeight()*2);
...
//                mSelectedItemUpButtonFloor = fragment.getUpButtonFloor();
        ...
        @Override
        public Fragment getItem(int position_loc) {
            mCursor.moveToPosition(position_loc);
            return ArticleDetailFragment.newInstance(mCursor.getLong(ArticleLoader.Query._ID), position_loc+position);
        }
